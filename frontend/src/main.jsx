...
createRoot(document.getElementById('root')).render(
  <BrowserRouter>
    <Routes>
      ...
      {/* Page 3~6 placeholders — 1B-3b/3c에서 구현 */}
      <Route path="/pipeline/data" element={<App><Placeholder title="Page 3 (1B-3b)" /></App>} />
...
function Placeholder({ title }) {
  return (
    <div>
      <h1>{title}</h1>
      <p className="muted">이 페이지는 다음 단계(STEP 1B-3b/3c)에서 구현됩니다.</p>
    </div>
  )
}
